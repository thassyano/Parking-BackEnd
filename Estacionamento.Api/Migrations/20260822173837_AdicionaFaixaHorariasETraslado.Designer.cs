...
namespace Estacionamento.Api.Migrations
{
    ...
    [Migration("20260822173837_AdicionaFaixaHorariasETraslado")]
    partial class AdicionaFaixaHorariasETraslado
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Estacionamento.Api.Domain.Entities.ConfiguracaoEstacionamento", b =>
                {
                    ...
                    b.Property<int>("TrasladoGratisAPartirDiarias")
                        .HasColumnType("integer");

                    b.Property<string>("UrlConfirmacaoFrontend")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<decimal>("ValorTraslado")
                        .HasPrecision(18, 2)
            ...
            modelBuilder.Entity("Estacionamento.Api.Domain.Entities.Preco", b =>
                {
                    ...
                    b.Property<decimal>("ValorHorasAdicionaisAte12h")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("ValorHorasAdicionaisAte6h")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("Estacionamento.Api.Domain.Entities.Reserva", b =>
                {
                    ...
                    b.Property<bool>("ComTraslado")
                        .HasColumnType("boolean");

                    b.Property<Guid>("ConfirmacaoToken")
                        .HasColumnType("uuid");

                    b.Property<bool>("ConfirmadaPeloCliente")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("DataEnvioConfirmacao")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<bool>("MensagemConfirmacaoEnviada")
                        .HasColumnType("boolean");
