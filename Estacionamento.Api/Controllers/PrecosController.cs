...
public class PrecosController : ControllerBase
{
    ...
    public async Task<IActionResult> Criar([FromBody] CriarPrecoDto dto)
    {
        ...
        try
        {
            var preco = await _precoService.CriarAsync(tipo, dto.ValorHorasAdicionaisAte6h, dto.ValorHorasAdicionaisAte12h, dto.ValorDiaria, dto.DescontoPixDinheiro, dto.DataInicio, dto.DataFim);
